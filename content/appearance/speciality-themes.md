...
Edit the colors, gradient classes, icons, labels, and descriptions in the frontmatter. Keep color values quoted. The neutral theme is used when no speciality is selected. Rebuild the site after editing.
