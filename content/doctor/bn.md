---
# Personal details: edit values, keep field names. See ../README.md for help.
# ব্যক্তিগত তথ্য: শুধু মানগুলো বদলান, ঘরের নাম অপরিবর্তিত রাখুন।
salutation: ডা.
firstName: ঐশর্য্য
middleName: লক্ষ্মী
lastName: পোদ্দার
...
# One qualification per line; reused on Home and Qualifications.
qualifications:
  - 'এমবিবিএস'
  - 'ডি-অর্থো'
---

Doctor details. Edit the values above in this language. Qualifications automatically appear on Home and Qualifications; biography and professional details appear on Profile.
